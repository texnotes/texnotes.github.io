function guess() {
	...
	if (!isNaN(hypothesis)) {
		...
		if (userGuess <= 10 && userGuess >= 0) { // && userGuess == hypothesis :( forgot about integer
			...
			console.log('Пользователь забыл ввести данные.'); // User press ok-key but not enter data
		} else if (hypothesis === null) {
			console.log('Пользователь отказался ввести данные.'); // User press cancel
		} else {
