...
function makeZoomable(node) {
	...
	$(doc).ready(function () {//Перестраховка на случай, если еще не создан DOM

//Добавляем в DOM компоненты lightbox (только один раз)
		if (!$(".underlay").length) {
			var $newdiv1 = $('<div class="underlay"></div>');
			var $newdiv2 = $('<div class="lightbox"><img class="zoom_img" src="#"><img class="zoom_btn" src="zoomer/img/close_button.png"></div>');
